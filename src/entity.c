...
void DrawEntity(Entity *ent)
{
  ...
  if(ent->weaponstate == -1)
	 ...
	 else
	{
		...
		if(ent->currentweapon==0)
		{
			if(ent->weapon != NULL)
			{
				DrawSprite(ent->weapon,screen,ent->fs.x + ent->s.x - Camera.x-ent->totaloffset ,ent->fs.y + ent->s.y - Camera.y-95,ent->weaponframe);
			}
		}
		if(ent->currentweapon==1)
		{
			if(ent->weapon !=NULL)
			{
				DrawSprite(ent->weapon,screen,ent->ss.x + ent->s.x - Camera.x-ent->totaloffset-50 ,ent->ss.y + ent->s.y - Camera.y-250,ent->weaponframe);
			}
		}
		if(ent->currentweapon==2)
		{
			if(ent->weapon !=NULL)
			{
				DrawSprite(ent->weapon,screen,ent->gs.x + ent->s.x - Camera.x-ent->totaloffset ,ent->gs.y + ent->s.y - Camera.y-95,ent->weaponframe);
			}
		}
		if(ent->currentweapon==3)
		{
			if(ent->weapon !=NULL)
			{
				DrawSprite(ent->weapon,screen,ent->ds.x + ent->s.x - Camera.x-ent->totaloffset-130 ,ent->ds.y + ent->s.y - Camera.y-150,ent->weaponframe);
			}
		}
		if(ent->currentweapon==4)
		{
			if(ent->weapon !=NULL)
			{
				DrawSprite(ent->weapon,screen,ent->aks.x + ent->s.x - Camera.x-ent->totaloffset-130 ,ent->aks.y + ent->s.y - Camera.y-150,ent->weaponframe);
			}
		}
		if(ent->currentweapon==5)
		{
			if(ent->weapon !=NULL)
			{
				DrawSprite(ent->weapon,screen,ent->acrs.x + ent->s.x - Camera.x-ent->totaloffset-130 ,ent->acrs.y + ent->s.y - Camera.y-175,ent->weaponframe);
			}
		}
		if(ent->currentweapon==6)
		{
			if(ent->weapon !=NULL)
			{
				DrawSprite(ent->weapon,screen,ent->shotys.x + ent->s.x - Camera.x-ent->totaloffset-130 ,ent->shotys.y + ent->s.y - Camera.y-175,ent->weaponframe);
			}
		}
	}
}
